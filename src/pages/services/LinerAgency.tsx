  ...
  const services = [
    {
      ...
      description: "Coordinating vessel arrivals, departures, and port operations",
    },
    {
      icon: FileText,
      title: "Documentation Management",
      description: "Handling all shipping documentation and compliance requirements",
    },
    {
      icon: Anchor,
      title: "Port Coordination",
      description: "Managing port operations, cargo handling, and logistics",
    },
    {
      icon: Container,
      title: "Cargo Booking",
      description: "Efficient cargo booking and space allocation services",
    },
  ];
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-20">
        {/* BREADCRUMB HERO – CONSISTENT WITH OTHER SERVICE PAGES */}
        <section
              ...
              <div className="space-y-12">
                ...
                <section>
                  ...
                  <div className="space-y-4 text-sm md:text-base leading-relaxed text-gray-700">
                    <p>{t("services.linerAgency.fullDescription")}</p>
                    <p>
                      We work closely with shipping lines, port authorities, and local service
                      providers to ensure that every call is handled efficiently—from berthing
                      and cargo handling to documentation and final delivery. Our experienced
                      team understands local regulations and port practices, helping principals
                      and customers avoid delays and additional costs.
                    </p>
                    <p>
                      With proactive communication, real-time updates, and a dedicated customer
                      service approach, we support both carriers and shippers with reliable liner
                      agency representation across our network ports.
                    </p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((service, index) => (
                      ...
                      >
                        <div className="bg-[#BC0018]/10 p-3 rounded-xl mb-4 w-fit">
                          <service.icon className="w-6 h-6 text-[#BC0018]" />
                        </div>
                ...
                <section className="py-12 bg-white text-center">
                  <h2 className="text-3xl md:text-4xl font-extrabold text-[#BC0018] mb-4">
                    Need Liner Agency Support?
                  </h2>
                  <p className="text-lg md:text-xl text-[#BC0018] mb-10">
                    Contact us for professional liner representation and seamless port
                    coordination.
                  </p>
