...
const OOGShipments: React.FC = () => {
  ...
  const servicesNav = [
    ...
    { label: "CFS Services", path: "/services/fcl" },
                ...
                <section>
                  ...
                  <div className="space-y-4 text-sm md:text-base leading-relaxed text-gray-700">
                    ...
                    <p>
                      ...
                      survey, ocean freight, and domestic movements. With a combination
                      of specialized handling equipment, experienced operations teams,
                      and strong carrier relationships, we ensure that every piece of
                      cargo is moved with precision and care.
                    </p>
                    <p>
                      Whether it is project machinery, industrial equipment, or
                      over-dimensional structures, our OOG and inter-island services
                      are built to deliver reliability, safety, and schedule integrity
